...
# used to enable pickling of instance methods, which is required for multiprocessing in Python.
...
class ConfusionMatrix(object):
    ...
    # Adds a single ground truth and prediction pair to the confusion matrix.
    ...
    # Adds a pre-computed confusion matrix to the existing one.
    ...
    # Generates a confusion matrix for a single ground truth and prediction pair.
...
# TODO: parse_args() is defined in eval.
